...
[![npm version](https://badge.fury.io/js/react-ui-kanban.svg)](https://badge.fury.io/js/react-ui-kanban)

#### Features Showcase
[Storybook](https://FelipeBattistotti.github.io/react-ui-kanban/)

## Features

![alt tag](https://raw.githubusercontent.com/FelipeBattistotti/react-ui-kanban/master/react-ui-kanban.gif)
...
```bash
$ yarn add react-ui-kanban
```

or

```bash
$ pnpm i react-ui-kanban
```
...
Check out the [editable board story](https://FelipeBattistotti.github.io/react-ui-kanban/?selectedKind=Editable%20Board&selectedStory=Add%2FDelete%20Cards&full=0&down=0&left=1&panelRight=0) and its corresponding [source code](https://github.com/FelipeBattistotti/react-ui-kanban/blob/master/stories/EditableBoard.story.js) for more details.
...
Use the predefined css classnames attached to these elements that go by `.react-ui-kanban-lane`, `.react-ui-kanban-card`, `.react-ui-kanban-board`:

```css
.react-ui-kanban-lane {
  border: 0;
...
//
// For example: { 'placeholder': { 'title': 'some text' } }
import { createTranslate } from 'react-ui-kanban'
const customTranslation = createTranslate(TRANSLATION_TABLE)

<Board t={customTranslation} .../>
```

List of available keys - [locales/en/translation.json](https://github.com/FelipeBattistotti/react-ui-kanban/blob/master/locales/en/translation.json)
...
<tr>
<td align="center">
<img src="https://avatars.githubusercontent.com/u/61482397?v=4" width="100px;" alt=""/>
<br /><sub><b>FelipeBattistotti</b></sub></a><br />
</td>
